...
export default defineConfig({
    ...
    redirects: {
        ...
        "/guides/lineage/using-lineage-agent": "/agent-studio-docs/get-started/recipes/document-lineage/",
        ...
        "/reference/agents/lineage-agent": "/agent-studio-docs/build/agents/lineage-agent/",
                        ...
                        items: [
                            ...
                            "get-started/key-concepts",
                            {
                                ...
                                items: [
                                    ...
                                    "get-started/recipes/document-lineage",
