                        ...
                        items: [
                            ...
                            "get-started/key-concepts",
                            {
                                ...
                                items: [
                                    ...
                                    "get-started/recipes/generate-data-products",
                                    "get-started/recipes/recommend-data-products",
                                ...
                                items: [
                                    ...
                                    "build/agents/publishing-agents",
                                    {
                                        ...
                                        items: [
                                            ...
                                            "build/agents/data-product-generator",
                                            "build/agents/data-product-query",
                                            "build/agents/data-product-recommender",
