...
<Aside type="tip">
Before deploying, make sure your agent is **published**. Draft agents are only visible to you and admin roles. See [Publishing and unpublishing agents](/guides/access-controls/roles-and-permissions/#publishing-and-unpublishing-agents-in-the-ui).
</Aside>
