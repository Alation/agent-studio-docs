...
Once you've [installed and configured](/agent-studio-docs/integrations/slack/setup/) the Alation AI Assistant, you're ready to start asking questions.
...
Change this to **Public** in the [Home tab settings](/agent-studio-docs/integrations/slack/setup/#mention-visibility) if you want everyone in the channel to see the response.
