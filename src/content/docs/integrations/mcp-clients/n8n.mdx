...
4. **Create an OAuth Client in Alation**
   ...
   Refer to the [OAuth 2.0 User Initiated Authentication Guide](/agent-studio-docs/security/authentication/user-initiated-auth) to create an OAuth Client. Use these settings:
...
1. **Obtain an access token**
   ...
   Refer to the [OAuth 2.0 M2M Authentication Guide](/agent-studio-docs/security/authentication/machine-to-machine) to create an OAuth Client and obtain an access token.
...
If you plan to use tools that execute SQL queries (SQL Execution, Get Data Schema), you must first [configure data warehouse credentials](/agent-studio-docs/security/authentication/machine-to-machine/#configuring-data-warehouse-credentials).
:::
