...
- **OAuth Client credentials** from your Alation instance ([Create OAuth Client](/agent-studio-docs/security/authentication/user-initiated-auth/))
...
2. **Add Custom Connector**
   ...
   ![Add custom connector dialog](../../../../assets/img/guides/mcp-client-setup/claude/claude-add-connector.png)
...
1. **Click Connect**
   ...
   Back on the Connectors page (or **Settings** → **Connectors** for Team/Enterprise plans), find your Alation connector showing "Disconnected" status and click **Connect**.

   ![Connector showing disconnected status with Connect button](../../../../assets/img/guides/mcp-client-setup/claude/claude-connector-disconnected.png)
...
2. **Sign in to Alation**
   ...
   ![Alation login page](../../../../assets/img/guides/mcp-client-setup/claude/claude-alation-login.png)
...
![Connectors menu showing Alation toggle](../../../../assets/img/guides/mcp-client-setup/claude/claude-connectors-menu.png)
...
2. Find your Alation connector and click **Configure**
   ...
   ![Alation connector with Configure button](../../../../assets/img/guides/mcp-client-setup/claude/claude-connector-configure.png)
