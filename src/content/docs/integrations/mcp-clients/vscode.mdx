...
Follow the [OAuth 2.0 User Initiated Authentication Guide](/agent-studio-docs/security/authentication/user-initiated-auth) to create an OAuth Client in your Alation instance.
...
1. **Start the MCP server**
   ...
   ![Start button in mcp.json](../../../../assets/img/guides/mcp-client-setup/vscode/vscode-mcp-json.png)

2. **Proceed through Registration**

   A modal appears saying "Dynamic Client Registration not supported". Click **Proceed**.

   ![Dynamic Client Registration modal](../../../../assets/img/guides/mcp-client-setup/vscode/vscode-dcr-modal.png)
...
4. **Allow authentication**
   ...
   ![Allow authentication modal](../../../../assets/img/guides/mcp-client-setup/vscode/vscode-mcp-allow-modal.png)
...
5. **Cancel the `localhost` authentication prompt**
   ...
   ![First external website modal with loopback address](../../../../assets/img/guides/mcp-client-setup/vscode/vscode-local-auth-modal.png)
...
6. **Accept the `vscode` authentication prompt**
   ...
   ![Trouble Toast](../../../../assets/img/guides/mcp-client-setup/vscode/vscode-mcp-trouble-toast.png)
   ...
   ![Second external website modal with vscode.dev redirect](../../../../assets/img/guides/mcp-client-setup/vscode/vscode-mcp-external-auth-modal.png)

7. **Sign in to Alation**

   Your browser opens the Alation login page. Sign in with your credentials.
   
   ![Alation Login Page](../../../../assets/img/guides/mcp-client-setup/vscode/vscode-mcp-alation-login.png)

8. **Verify connection**

   After signing in, VS Code shows the server as "Running" with a number of available tools.

   ![Server running with tools](../../../../assets/img/guides/mcp-client-setup/vscode/vscode-mcp-success.png)
...
![Configure Tools panel](../../../../assets/img/guides/mcp-client-setup/vscode/vscode-tools-list.png)
