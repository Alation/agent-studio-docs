...
1. **Open settings**
   ...
   ![Settings Apps page](../../../../assets/img/guides/mcp-client-setup/chatgpt/chatgpt-settings-apps.png)

2. **Enable developer mode**

   Click **Advanced settings**, then toggle on **Developer mode**.

   ![Developer mode toggle](../../../../assets/img/guides/mcp-client-setup/chatgpt/chatgpt-developer-mode.png)

   Once enabled, you'll see a **Create app** button on the Apps page.

   ![Create app button visible](../../../../assets/img/guides/mcp-client-setup/chatgpt/chatgpt-create-app-button.png)
...
2. **Fill in the app details**
   ...
   ![New App form](../../../../assets/img/guides/mcp-client-setup/chatgpt/chatgpt-new-app-form.png)
...
1. **Sign in to Alation**
   ...
   ![Alation login page](../../../../assets/img/guides/mcp-client-setup/chatgpt/chatgpt-alation-login.png)
...
2. **Verify connection**
   ...
   ![Connected app showing tools](../../../../assets/img/guides/mcp-client-setup/chatgpt/chatgpt-connected.png)
...
![Enabling Alation MCP in chat](../../../../assets/img/guides/mcp-client-setup/chatgpt/chatgpt-enable-in-chat.png)
