...
Follow the [User-Initiated OAuth Client guide](/agent-studio-docs/security/authentication/user-initiated-auth/) to create an OAuth client in your Alation instance. Use the redirect URI from Step 1.
...
Once authenticated, you should see the Alation MCP tools available in LibreChat. For a full list of available tools and what they do, see the [Tools Reference](/agent-studio-docs/build/tools/configuring-tools/).
