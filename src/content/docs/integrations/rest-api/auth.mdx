...
If you plan to call agents that execute SQL queries (Query, Data Product Query, Analytics, Chart Generation), you must first configure data warehouse credentials. See [Configuring Data Warehouse Credentials](/agent-studio-docs/security/authentication/machine-to-machine/#configuring-data-warehouse-credentials) for setup instructions.
...
We recommend using the [Agent Studio SDK](/agent-studio-docs/integrations/sdk/using-the-sdk/) for interacting with the REST API.
