...
| Restricted | Viewer, Explorer | Can view and use published agents; cannot create, edit, delete, or clone agents or flows (can create and manage their own custom tools) |
