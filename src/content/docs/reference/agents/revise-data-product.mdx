...
- **Reasoning mode**: Extended thinking (up to 4,096 token budget)
...
- **Deferred tools**: This agent uses deferred tool execution for long-running evaluation and update operations
