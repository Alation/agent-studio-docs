...
This tool produces a chart (a visualization) from tabular data. It backs the out-of-the-box [Chart Generation](/agent-studio-docs/reference/agents/chart-generation) and [Analytics Agent](/agent-studio-docs/reference/agents/analytics-agent) agents.
...
- [Chart Generation agent](/agent-studio-docs/reference/agents/chart-generation)
