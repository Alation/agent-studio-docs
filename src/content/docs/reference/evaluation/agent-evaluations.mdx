...
- **SQL evaluation**: Tests data products by evaluating SQL query generation accuracy via executing SQL and comparing tables. See [SQL Evaluations for Data Products](/reference/evaluation/data-product-evaluations).
