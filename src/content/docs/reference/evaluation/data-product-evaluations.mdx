...
- **Generic evaluation**: Tests agents using LLM-as-judge evaluation with custom rubrics. See [Agent Evaluations](/reference/evaluation/agent-evaluations).
...
- There is an [Error Analysis Tool](https://github.com/Alation/alation-ai/tree/main/contrib/error_analysis_tool) in Alation AI which helps visualize the JSON reports.
