...
<div class="recipe-cost not-content">
  ...
  <p class="recipe-cost__note">Two to three metered actions per question, the same whether the agent is called from Snowflake or anywhere else. <a href="/agent-studio-docs/security/observability/usage/#how-consumption-is-priced">At 0.25 ACU per metered action</a>; confirm actual spend on the <a href="/agent-studio-docs/security/observability/usage/">Usage page</a>.</p>
</div>
