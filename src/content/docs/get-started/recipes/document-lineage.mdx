...
<div class="recipe-cost not-content">
  <div class="recipe-cost__main">
    ...
    <span class="recipe-cost__figure">0.5–1<span class="recipe-cost__acu">ACU</span><span class="recipe-cost__per">per object</span></span>
  </div>
  <p class="recipe-cost__note">A few metered actions per documented object (the lineage fetch plus the agent's writing call). <a href="/agent-studio-docs/security/observability/usage/#how-consumption-is-priced">At 0.25 ACU per metered action</a>; confirm actual spend on the <a href="/agent-studio-docs/security/observability/usage/">Usage page</a>.</p>
</div>
