...
The assistant starts a thread with your default agent selected.

![DM chat view with agent selector](../../../../assets/img/guides/slack/08-dm-chat-view-with-agent-selector.png)

Type your question and the agent responds in the same thread.
