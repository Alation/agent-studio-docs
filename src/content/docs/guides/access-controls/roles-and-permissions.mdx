...
<Aside type="note">
The Agent Studio UI does not currently have a publish button. To publish an agent, use the API. See [Publishing an agent via API](#publishing-an-agent-via-api) below.
</Aside>
