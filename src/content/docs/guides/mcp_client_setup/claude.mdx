...
2. **Add Custom Connector**
   ...
   ![Add custom connector dialog](../../../../assets/img/guides/mcp-client-setup/claude-add-connector.png)
...
1. **Click Connect**
   ...
   ![Connector showing disconnected status with Connect button](../../../../assets/img/guides/mcp-client-setup/claude-connector-disconnected.png)
...
2. **Sign in to Alation**
   ...
   ![Alation login page](../../../../assets/img/guides/mcp-client-setup/claude-alation-login.png)
...
![Connectors menu showing Alation toggle](../../../../assets/img/guides/mcp-client-setup/claude-connectors-menu.png)
...
2. Find your Alation connector and click **Configure**
   ...
   ![Alation connector with Configure button](../../../../assets/img/guides/mcp-client-setup/claude-connector-configure.png)
