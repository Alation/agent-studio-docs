---
title: Claude Setup
description: Connect Claude to Alation via Remote MCP Server
---

import { Steps } from '@astrojs/starlight/components';

Connect Claude (web, desktop, and mobile) to your Alation catalog using the Remote MCP server with OAuth authentication.
