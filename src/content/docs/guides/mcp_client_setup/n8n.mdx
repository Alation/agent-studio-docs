...
1. Create an OAuth Client
   ...
   | Field                | Value                                                                                                      |
   | -------------------- | ---------------------------------------------------------------------------------------------------------- |
   | name                 | Any name to identify the client.<br/> e.g. `"n8n-mcp-client"`                                              |
   | client_type          | `"confidential"`                                                                                           |
   | redirect_uris        | Taken from the n8n oauth setup page.<br/> e.g. `["http://localhost:5678/rest/oauth2-credential/callback"]` |
   | refresh_token_expiry | Refresh token lifetime in seconds.<br/>e.g. `259200`                                                       |
   | access_token_expiry  | Access token lifetime in seconds.<br/>e.g. `3600`                                                          |
   | pkce_required        | `true`                                                                                                     |
