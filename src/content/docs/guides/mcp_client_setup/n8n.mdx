...
2. **Configure server transport**
   ...
   ![MCP Client Tool parameters](../../../../assets/img/guides/mcp_client_setup/n8n/node-parameters.png)
...
![Authentication Methods](../../../../assets/img/guides/mcp_client_setup/n8n/auth-methods.png)
...
2. **Disable Dynamic Client Registration**
   ...
   ![Dynamic Client Registration disabled](../../../../assets/img/guides/mcp_client_setup/n8n/oauth-1.png)
...
4. **Create an OAuth Client in Alation**
   ...
   Refer to the [OAuth 2.0 User Initiated Authentication Guide](/agent-studio-docs/guides/authentication/user_initiated_auth) to create an OAuth Client. Use these settings:
...
5. **Configure OAuth2 credentials**
   ...
   ![OAuth2 Configuration](../../../../assets/img/guides/mcp_client_setup/n8n/oauth-2.png)
...
7. **Verify connection**
   ...
   ![Account connected](../../../../assets/img/guides/mcp_client_setup/n8n/account-connected.png)
...
1. **Obtain an access token**
   ...
   Refer to the [OAuth 2.0 M2M Authentication Guide](/agent-studio-docs/guides/authentication/machine_to_machine) to create an OAuth Client and obtain an access token.
