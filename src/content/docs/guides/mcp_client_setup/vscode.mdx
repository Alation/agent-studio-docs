...
1. **Start the MCP server**
   ...
   ![Start button in mcp.json](../../../../assets/img/guides/mcp_client_setup/vscode/vscode-start-button.png)
...
4. **Allow authentication**
   ...
   ![Allow authentication modal](../../../../assets/img/guides/mcp_client_setup/vscode/vscode-allow-modal.png)
...
5. **Cancel the first browser prompt**
   ...
   ![First external website modal with loopback address](../../../../assets/img/guides/mcp_client_setup/vscode/vscode-external-cancel.png)
...
6. **Accept the second browser prompt**
   ...
   ![Second external website modal with vscode.dev redirect](../../../../assets/img/guides/mcp_client_setup/vscode/vscode-external-open.png)
...
8. **Verify connection**
   ...
   ![Server running with tools](../../../../assets/img/guides/mcp_client_setup/vscode/vscode-running.png)
