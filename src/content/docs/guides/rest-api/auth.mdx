...
If you plan to call agents that execute SQL queries (Query, Data Product Query, Analytics, Chart Generation), you must first configure data warehouse credentials. See [Configuring Data Warehouse Credentials](/agent-studio-docs/guides/authentication/machine-to-machine/#configuring-data-warehouse-credentials) for setup instructions.
