...
![Adding Custom Tool](../../../../assets/img/guides/rest_api/snowflake-adding_custom_tool.png)

## Step 7: Test it out

Once the agent is saved with the custom tool, we can try it out in playground and/or Snowflake intelligence
![Test Snowflake Intelligence](../../../../assets/img/guides/rest_api/snowflake-leveraging_alation_context_agent.png)
