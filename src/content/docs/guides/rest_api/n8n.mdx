...
Follow the [Authentication Guide](/agent-studio-docs/guides/authentication/machine_to_machine/) to create an OAuth 2.0 Client in your Alation instance.
...
2. Fill in the following fields to configure the node:
   ...
   <details>
     ...
     ![Authentication Methods](../../../../assets/img/guides/rest_api/n8n-access-token1.png)
     ![Authentication Methods](../../../../assets/img/guides/rest_api/n8n-access-token2.png)
   </details>
...
2. Fill in the following fields to configure the node:
    ...
    <details>
     <summary>Example configuration screenshots</summary>
    ![Authentication Methods](../../../../assets/img/guides/rest_api/n8n-call-agent1.png)
    ![Authentication Methods](../../../../assets/img/guides/rest_api/n8n-call-agent2.png)
    </details>
...
![Authentication Methods](../../../../assets/img/guides/rest_api/n8n-workflow.png)
