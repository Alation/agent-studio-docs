...
Follow the [Authentication Guide](/guides/mcp_auth/create_oauth_client) to create an OAuth 2.0 Client in your Alation instance.
...
{/* TODO: replace with the correct link */}
We recommend using the [Agent Studio SDK](/getting-started/sdks/python-sdk) for interacting with the REST API.
