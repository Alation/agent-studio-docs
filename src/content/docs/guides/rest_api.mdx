---
title: REST API
description: Learn how to authenticate and call the REST APIs using OAuth 2.0 Client Credentials Grant.
---
...
Follow the [Authentication Guide](/agent-studio-docs/guides/mcp_auth/create_oauth_client) to create an OAuth 2.0 Client in your Alation instance.
...
{/* TODO: replace with the correct link */}
We recommend using the [Agent Studio SDK](/agent-studio-docs/getting-started/sdks/python-sdk) for interacting with the REST API.
