...
If you plan to use tools that execute SQL queries (SQL Execution, Get Data Schema), you must first [configure data warehouse credentials](/agent-studio-docs/guides/authentication/machine_to_machine/#configuring-data-warehouse-credentials).
:::
