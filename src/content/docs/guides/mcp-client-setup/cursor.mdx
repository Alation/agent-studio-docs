...
<Badge text="Available from 2026.2.0" variant="success" size="small" /> Connect your Alation catalog to Cursor using the Remote MCP Server with OAuth authentication.
