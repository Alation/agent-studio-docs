---
title: Introduction
description: Explains the modes of authentication available in Alation Agent Studio.
---
import { LinkCard, CardGrid } from '@astrojs/starlight/components';

Alation AI Studio supports multiple authentication modes — both for accessing Alation resources (MCP server, REST APIs) and for agents connecting to external data sources.

<LinkCard
  title="Agent Authentication to Data Sources"
  description="How agents authenticate when executing SQL queries or calling external APIs, including user-level access control"
  href="../agent-datasource-auth/">
</LinkCard>
