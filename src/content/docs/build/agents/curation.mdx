...
- The agent may not exhaustively update all relevant objects in a single run, and is intended for small, interactive updates. Alation's bulk [Curation Automation](https://docs.alation.com/en/latest/steward/OutcomeBasedGovernance/CurationAutomation/index.html#) tool is recommended for bulk updates.
