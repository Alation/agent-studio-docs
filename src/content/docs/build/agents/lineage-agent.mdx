...
- **[Get Lineage](/agent-studio-docs/build/tools/get-lineage-tool)**: Fetches the upstream or downstream lineage graph for a table or column.
- **[Generate Lineage Documentation](/agent-studio-docs/build/tools/generate-lineage-documentation-tool)**: Analyzes column-level transformations for a table and optionally writes them into a document.
