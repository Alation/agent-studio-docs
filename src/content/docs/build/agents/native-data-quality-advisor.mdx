...
- `table_metadata` (object): Structured table and column payload that drives recommendation mode. When supplied, the agent proposes checks for each column described.
