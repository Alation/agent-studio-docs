...
These evaluation sets are what you use to measure and improve a text-to-SQL agent's accuracy. See [SQL Evaluations](/agent-studio-docs/build/evals/sql-evaluations) for the broader workflow.
...
- [Data Product Evaluations](/agent-studio-docs/build/evals/data-product-evaluations)
