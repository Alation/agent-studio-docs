...
8. **Set the agent's privacy**
   - New agents start **private**, visible only to you
   - In the agent's **Agent Access** tab, use **Agent privacy** to set it to **Public** (everyone gets a role you choose), or grant specific users/groups a role while keeping it private
   - See [Agent Privacy](/agent-studio-docs/build/agents/agent-privacy/) for details
...
<Aside type="tip">
Before deploying, make sure the agent's **Agent privacy** setting gives the people who need it access. A new agent is private to you by default. See [Agent Privacy](/agent-studio-docs/build/agents/agent-privacy/).
</Aside>
