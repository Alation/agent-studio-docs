...
For a comprehensive usage guide with examples and tips, see the [Catalog Context Search Guide](/agent-studio-docs/get-started/recipes/catalog-context-search/).
