...
The agent reads the chat history, decides how to organize the report (headings, sections, tables), and renders it to a PDF using the [Generate PDF](/agent-studio-docs/build/tools/generate-pdf-tool) tool. The finished PDF is saved as a downloadable asset.
...
- **[Generate PDF](/agent-studio-docs/build/tools/generate-pdf-tool)**: Renders the report and saves it as a downloadable asset.
...
- [Generate PDF Tool](/agent-studio-docs/build/tools/generate-pdf-tool)
