...
For example:
1. An [agent](/agent-studio-docs/build/agents/overview/) generates a chart and returns the image URL
2. An email [tool](/agent-studio-docs/build/tools/overview/) sends that URL as an attachment
...
- [Scheduling Flows](/agent-studio-docs/build/schedules/scheduling-flows/) — Automate flow execution with schedules
