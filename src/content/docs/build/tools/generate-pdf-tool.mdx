...
This tool turns content from a conversation into a formatted, downloadable PDF report. It is what powers the out-of-the-box [Generate PDF from a Chat](/agent-studio-docs/build/agents/generate-pdf-from-a-chat) agent.
...
- [Generate PDF from a Chat](/agent-studio-docs/build/agents/generate-pdf-from-a-chat)
