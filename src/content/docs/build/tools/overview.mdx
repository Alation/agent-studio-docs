---
title: "Tools"
description: "How tools work in Agent Studio and how to configure tool parameters with Fixed, User input, and Agent determined scopes."
---
...
- [Configuring tool parameters](/agent-studio-docs/build/tools/configuring-tools/) — the Fixed vs. User input vs. Agent determined scopes, explained.
- [Creating custom tools](/agent-studio-docs/build/tools/creating-custom-tools/) — HTTP and SMTP tools for systems the built-ins don't cover.
- [Integrations](/agent-studio-docs/integrations/overview/) — put your tools to work in Slack, MCP clients, and your own apps.
