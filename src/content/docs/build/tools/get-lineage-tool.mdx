...
Add this tool to an agent that needs to reason about data flow, dependencies, or impact analysis. It powers the out-of-the-box [Lineage Agent](/agent-studio-docs/build/agents/lineage-agent).
