...
1. **Generate a JWT access token**
   ...
   Follow the [Machine-to-Machine OAuth guide](/agent-studio-docs/security/authentication/machine-to-machine/) to:
...
If a scheduled run fails with a "schema mismatch" or similar error, it means an [agent](/agent-studio-docs/build/agents/overview/) or [tool](/agent-studio-docs/build/tools/overview/) used in your flow was modified after the flow was created.
...
- [Variables and Context](/agent-studio-docs/build/flows/variables/) — Learn how data flows between steps
- [Flows overview](/agent-studio-docs/build/flows/overview/) — Return to the main flows introduction
